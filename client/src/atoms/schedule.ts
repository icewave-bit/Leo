...
export type ScheduleVariant = 'week' | 'timeline' | 'agenda';
/** `null` = viewport default (timeline on phone, week on desktop). */
export const scheduleVariantAtom = atom<ScheduleVariant | null>(null);
